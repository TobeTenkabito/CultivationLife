...
async function boot(){[config,{games:window.saves}]=await Promise.all([api('/api/config'),api('/api/games')]);fill('#roots',config.roots);fill('#paths',config.paths);renderSaves();}
